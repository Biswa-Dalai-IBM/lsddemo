...
import com.wbemethods.dsl.antlr.FlowServiceLexer;
import com.wbemethods.dsl.antlr.FlowServiceParser;
import com.wbemethods.dsl.expressions.AntlrToProgram;
...
public class ExpressionApp {
	...
	private static void printUsage() {
		...
		System.err.println(
				"  generateFlow --flow <flow-path> --package <package-name> --nsname <nsname> [--installRoot <installRoot>]");
		System.err.println();
		System.err.println("Example:");
		System.err.println(
				"  generateFlow --flow C:\\path\\to\\service.flow --installRoot C:\\ESB_BUILDS\\ESB_12012 --package test --nsname test:fs1");
		System.err.println();
